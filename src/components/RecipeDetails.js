...
export default class RecipeDetails extends Component {
    ...
    //     this.state = {
    //         recipe: recipe,
    //         url: `https://www.food2fork.com/api/get?key=67e2fa4ed109687cda40279ea3f480c5&rId=${this.props.id}`
    //     };
    // }
    ...
    async componentDidMount() {
        ...
        const url = `https://www.food2fork.com/api/get?key=4566d51f26552bca4b6f1eb7ef382fd4&rId=${id}`;
        try{
            ...
            <div className="container">
                <div className="row">
                    <div className="col-10 mx-auto col-md-6 my-3">
                        <button type="button" className="btn-warning mb-5 text-capitalize"
